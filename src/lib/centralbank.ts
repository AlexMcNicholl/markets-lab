...
export const STATEMENTS: Record<Bank, Statement[]> = {
  boc: [
    ...
    },
    {
      ...
      bank: "boc",
      date: "Oct 2024",
      descriptor: "Larger 50 bp cut to support growth",
      rate: "3.75%",
      action: "cut",
      text: "The Bank of Canada today reduced its target for the overnight rate to 3.75 per cent. CPI inflation has declined significantly from 2.7 per cent in June to 1.6 per cent in September. The labour market remains soft — the unemployment rate was at 6.5 per cent in September. With inflation now back around the 2 per cent target, Governing Council decided to reduce the policy rate by 50 basis points to support economic growth.",
    },
  ],
  fed: [
    {
      ...
      bank: "fed",
      date: "Mar 2020",
      descriptor: "Emergency cut to the zero lower bound",
      rate: "0–0.25%",
      action: "cut",
      text: "The coronavirus outbreak has harmed communities and disrupted economic activity in many countries, including the United States. The Committee decided to lower the target range for the federal funds rate to 0 to 1/4 percent. The Committee will continue to monitor the implications of incoming information for the economic outlook, and it is prepared to use its full range of tools to support the flow of credit to households and businesses.",
    },
    {
      id: "fed-2022-03",
      bank: "fed",
    ...
    },
    {
      ...
      bank: "fed",
      date: "Dec 2024",
      descriptor: "Quarter-point cut, signalling a slower pace",
      rate: "4.25–4.50%",
      action: "cut",
      text: "Recent indicators suggest that economic activity has continued to expand at a solid pace. Since earlier in the year, labor market conditions have generally eased, and the unemployment rate has moved up but remains low. Inflation has made progress toward the Committee's 2 percent objective but remains somewhat elevated. The Committee decided to lower the target range for the federal funds rate by 1/4 percentage point to 4-1/4 to 4-1/2 percent. In considering the extent and timing of additional adjustments to the target range for the federal funds rate, the Committee will carefully assess incoming data, the evolving outlook, and the balance of risks.",
    },
  ],
};
